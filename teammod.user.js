...
$(document).ready(function() {
    ...
    function goToPost(pid) {
        ...
        if(location.pathname.includes('/admin/dashboard')) {
            const link = $(`<a href="https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/q/${pid}" target="_blank" style="display:none !important;">&nbsp;</a>`).appendTo('body');
            link[0].click();
            link.remove();
        }
        else {
            location.href = `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/q/${pid}`;
        }
    }
    function reloadPage() {
    ...
    function addComment(pid, commentText) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/posts/${pid}/comments`,
                data: {
                    'fkey': fkey,
                    'comment': commentText,
                }
    ...
    function closeQuestionAsOfftopic(pid, closeReasonId = 'SiteSpecific', offtopicReasonId = 3, offTopicOtherText = 'I’m voting to close this question because ', duplicateOfQuestionId = null) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/flags/questions/${pid}/close/add`,
                data: {
                    'fkey': fkey,
    ...
    function reopenQuestion(pid) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/flags/questions/${pid}/reopen/add`,
                data: {
                    'fkey': fkey
                }
            })
    ...
    function deletePost(pid) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/posts/${pid}/vote/10`,
                data: {
                    'fkey': fkey
                }
            })
    ...
    function undeletePost(pid) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/posts/${pid}/vote/11`,
                data: {
                    'fkey': fkey
                }
            })
    ...
    function lockPost(pid, type, hours = 24) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/posts/${pid}/lock`,
                data: {
                    'mod-actions': 'lock',
                    'noticetype': type,
                    'duration': hours,
    ...
    function unlockPost(pid) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/posts/${pid}/unlock`,
                data: {
                    'mod-actions': 'unlock',
                    'fkey': fkey
                }
    ...
    function protectPost(pid) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/posts/${pid}/protect`,
                data: {
                    'mod-actions': 'protect',
                    'duration': 1,
                    'fkey': fkey
    ...
    function unprotectPost(pid) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/posts/${pid}/unprotect`,
                data: {
    ...
    function tryRemoveMultipleAtFromPost(pid) {
        return new Promise(function(resolve, reject) {
            ...
            $.get(`https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/posts/${pid}/edit`)
            .done(function(data) {
                ...
                $.post({
                    url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}${editUrl}`,
                    data: {
                        'is-current': true,
    ...
    function convertToComment(pid, targetId) {
        return new Promise(function(resolve, reject) {
            ...
            tryRemoveMultipleAtFromPost(pid).then(v => {
                $.post({
                    url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/posts/${pid}/convert-to-comment`,
                    data: {
    ...
    function convertToEdit(pid, targetId) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/posts/${pid}/convert-to-edit`,
                data: {
    ...
    function deleteCommentsOnPost(pid) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/posts/${pid}/delete-comments`,
                data: {
                    'fkey': fkey,
    ...
    function moveCommentsOnPostToChat(pid) {
        alert("This feature is not available in private teams.");
        /*return new Promise(function(resolve, reject) {
            if(typeof pid === 'undefined' || pid == null) { reject(); return; }

            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/posts/${pid}/move-comments-to-chat`,
                data: {
                    'fkey': fkey,
    ...
    function spamFlagPost(pid) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}${StackExchange.options.site.routePrefix || ""}/flags/posts/${pid}/add/PostSpam`,
                data: {
                    'otherText': null,
    ...
    function getUserPii(uid) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/all-pii`,
                data: {
                    'id': uid,
                    'fkey': fkey,
                }
    ...
    function modMessage(uid, message = '', sendEmail = true, suspendDays = 0) {
        return new Promise(function(resolve, reject) {
            ...
            $.post({
                url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/users/message/save`,
                data: {
                    'userId': uid,
                    'lastMessageDate': 0,
                    'email': sendEmail,
    ...
    function deleteUser(uid, deleteDetails = null) {
        return new Promise(function(resolve, reject) {
            ...
            getUserPii(uid).then(v => {
                ...
                // Delete user
                $.post({
                    url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/users/${uid}/delete`,
                    data: {
                        'annotation': '',
                        'deleteReasonDetails': '',
                        'mod-actions': 'delete',
    ...
    function destroySpammer(uid, destroyDetails = null) {
        return new Promise(function(resolve, reject) {
            ...
            getUserPii(uid).then(v => {
                ...
                // Destroy user
                $.post({
                    url: `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/users/${uid}/destroy`,
                    data: {
                        'annotation': '',
                        'deleteReasonDetails': '',
                        'mod-actions': 'destroy',
    ...
    function updateModTemplates() {
        ...
        pids.forEach(function(v) {
            ...
            addstr += `https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/a/${v}` + newlines;
        });
    ...
    function initPostDissociationHelper() {
        ...
        if(location.pathname.includes('/admin/dashboard')) {
            ...
            dissocPosts.each(function() {
                ...
                $('.js-post-flag-options', this).prepend(`<a href="https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/admin/cm-message/create/${uid}?action=post-dissociation&pid=${pid}" class="btn" target="_blank">dissociate</a>`);
        ...
        $('#content, main').on('click', '.post-mod-menu a', function() {
            ...
            switch(action) {
                ...
                case 'convert-edit':
                    ...
                    break;
                case 'toggle-protect': {
                        if(post.find('.s-notice').text().includes('protect')) unprotectPost(pid).finally(reloadPage);
                    ...
                    if(confirm(`Suspend for 365, and DELETE the user "${uName}" (id: ${uid})???`) &&
                       (underSpamAttackMode || confirm(`Are you VERY SURE you want to DELETE the account "${uName}"???`))) {
                        ...
                        deleteUser(uid).then(function() {
                            if(!isSuperuser && !underSpamAttackMode) window.open(`https://${location.hostname}${StackExchange.options.site.routePrefix || ""}/users/${uid}`);
                            removePostFromModQueue();
                            reloadPage();
                        });
                    }
